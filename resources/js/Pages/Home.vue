<template>
  <PublicLayout>
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 text-white py-20 md:py-32 overflow-hidden">
      <!-- Decorative Elements -->
      ...
      <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
            Accédez à des formations professionnelles de qualité en ligne et en présentiel. Obtenez des certifications reconnues.
          </p>
    ...
    <section class="py-20 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-bold text-gray-900 mb-4">Formations en Vedette</h2>
          <p class="text-xl text-gray-600">Découvrez nos meilleures formations recommandées par nos experts</p>
        </div>
    ...
    <section id="categories" class="py-20 bg-white">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-bold text-gray-900 mb-4">Domaines de Formation</h2>
          <p class="text-xl text-gray-600">Explorez nos catégories de formations professionnelles</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <div class="text-4xl mb-3">{{ getCategoryEmoji(category.nom.fr) }}</div>
            <h3 class="text-lg font-bold text-gray-900 mb-2">{{ category.nom.fr }}</h3>
            <p class="text-sm text-gray-600 mb-4 line-clamp-2">{{ category.description.fr }}</p>
            <Link
    ...
    <section class="py-20 bg-gray-50">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600">Ce que nos étudiants pensent de nos formations</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div v-for="testimonial in testimonials" :key="testimonial.id" class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition">
            <div class="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600">{{ testimonial.formation }}</p>
              </div>
            </div>
    ...
    <section class="py-16 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
      <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl mb-8 text-blue-100">Inscrivez-vous dès maintenant et accédez à toutes nos formations</p>
        <Link
          href="/register"
...
const testimonials = [
  {
    ...
    text: 'Excellente formation ! Les instructeurs sont très compétents et le contenu est pratique et applicable immédiatement.',
  },
  {
    id: 2,
    name: 'Marie Martin',
    ...
    text: 'Formation complète avec de vrais projets. J\'ai pu appliquer mes apprentissages dans mon travail en moins de 3 mois.',
  },
  {
    id: 3,
    name: 'Pierre Bernard',
    ...
    text: 'Vraiment satisfait ! Les modules sont bien structurés et le support pédagogique est excellent.',
  }
];
